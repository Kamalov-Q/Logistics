...
const Footer = () => {
    return (
        <div className='container mx-auto py-5 w-full'>
            <div>
                <div className='flex justify-evenly items-center border-b-2 p-5'>
                    <div className='flex gap-3 flex-col'>
                        <div className='my-2 font-semibold text-xl'>Asosiy</div>
                    ...
                    <div className='flex gap-3 flex-col'>
                        <div className='my-2 font-semibold text-xl'>Kontaktlar</div>
